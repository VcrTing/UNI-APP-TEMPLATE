<template>
    ...
    <view class="sales-order-center">
        <view class="pb-x2">
            <view class="o-table my" :style="{ 'width': table.w }">
                <view class="o-theader ps-s t-0">
                    
                    <!-- TH -->
                    <view class="o-th py-s">
                        <view 
                            :style="v.__style" 
                            :class="v.__class"
                            class="o-td"
                            v-for="(v, i) in aii.columns" :key="i">
                            <view class="o-td-inner">
                                {{ v.title }}
                            </view>
                        </view>
                    </view>
                </view>
                <view class="o-tbody pt-s">

                    <!-- TR -->
                    <view class="o-tr"
                        v-for="(d, idx) in data" :key="idx"
                        :class="(idx == (data.length - 1)) ? 'o-td-last ps-s b-0' : ''"
                    >
                        <view 
                            :style="v.__style" 
                            :class="v.__class"
